...
import com.androidproject.sudiet.adapter.A1cEstimateAdapter;
import com.androidproject.sudiet.presenter.OverviewPresenter;
import com.androidproject.sudiet.tools.FormatDateTime;
import com.androidproject.sudiet.tools.GlucoseRanges;
import com.androidproject.sudiet.tools.GlucosioConverter;
import com.androidproject.sudiet.tools.ReadingTools;
import com.androidproject.sudiet.tools.TipsManager;
import com.androidproject.sudiet.view.OverviewView;
...
public class OverviewFragment extends Fragment implements OverviewView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SuDietApplication app = (SuDietApplication) getActivity().getApplicationContext();
    ...
    private void showA1cDialog() {
        final Dialog a1CDialog = new Dialog(getActivity());
